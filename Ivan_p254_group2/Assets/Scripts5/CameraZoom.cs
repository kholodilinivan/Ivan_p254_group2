...
public class CameraZoom : MonoBehaviour
{
    ...
    void Update()
    {
        if (Camera.main.orthographic)
        {
            ...
            Camera.main.orthographicSize = Mathf.Clamp(Camera.main.orthographicSize, 1, 5); // restricts value within [1;5]
        }
        ...
        else
        {
            ...
            Camera.main.fieldOfView = Mathf.Clamp(Camera.main.fieldOfView, 10, 60); // restricts value within [10;60]
        }
    }
}
